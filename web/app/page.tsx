  ...
  return (
    <header className="p-6 border-b border-foreground/20">
      <div className="max-w-6xl mx-auto flex justify-between items-center">
        <h1 className="text-2xl font-bold">[ Scott Capital ]</h1>
        {isAuthenticated && (
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-6">
        <Feature text="Track active positions" />
        <Feature text="Monitor your portfolio" />
        <Feature text="Analyze your trades" />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="w-full max-w-md mx-auto space-y-6">
      <div className="border border-foreground p-8 space-y-6">
        <div className="space-y-2">
          <h3 className="text-xl font-bold">
            {isSignUp ? "CREATE YOUR ACCOUNT" : "SIGN IN TO SCOTT CAPITAL"}
          </h3>
